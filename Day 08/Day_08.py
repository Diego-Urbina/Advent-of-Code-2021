class Entry:
    ...
    def num_unique_segments_outputs(self):
        ...
        for output in self.outputs:
            if (len(output) == 2 or len(output) == 3 or
                len(output) == 4 or len(output) == 7):
                count += 1
        return count
    ...
    def decode_segments(self):
        ...
        # Get common segments
        common_segs_nums_069 = set(segs_nums_069[0]).intersection(set(segs_nums_069[1])).intersection(set(segs_nums_069[2]))
        ...
        seg_3 = in_4_not_in_1.intersection(diff_segs_nums_069_0).union(in_4_not_in_1.intersection(diff_segs_nums_069_1)).union(in_4_not_in_1.intersection(diff_segs_nums_069_2))
